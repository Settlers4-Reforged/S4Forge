...
namespace Forge.Game.World.Entities.Native.Units
{
    ...
    public unsafe partial struct CWarShip : CWarShip.Interface
    {
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CWarShip*, uint, uint>)(lpVtbl_Base1[6]))((CWarShip*)Unsafe.AsPointer(ref this), health);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CWarShip*, uint, uint, void>)(lpVtbl_Base1[7]))((CWarShip*)Unsafe.AsPointer(ref this), damage, attackingEntityId);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CWarShip*, uint, void>)(lpVtbl_Base1[8]))((CWarShip*)Unsafe.AsPointer(ref this), damage);
        }
