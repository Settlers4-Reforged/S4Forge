...
namespace Forge.Game.World.Entities.Native.Units
{
    ...
    public unsafe partial struct CMayaWarShip : CMayaWarShip.Interface
    {
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CMayaWarShip*, uint, uint>)(lpVtbl_Base1[6]))((CMayaWarShip*)Unsafe.AsPointer(ref this), health);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CMayaWarShip*, uint, uint, void>)(lpVtbl_Base1[7]))((CMayaWarShip*)Unsafe.AsPointer(ref this), damage, attackingEntityId);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CMayaWarShip*, uint, void>)(lpVtbl_Base1[8]))((CMayaWarShip*)Unsafe.AsPointer(ref this), damage);
        }
