...
namespace Forge.Game.World.Entities.Native.Units
{
    ...
    public unsafe partial struct CManakopter : CManakopter.Interface
    {
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CManakopter*, uint, uint>)(lpVtbl[6]))((CManakopter*)Unsafe.AsPointer(ref this), health);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CManakopter*, uint, uint, void>)(lpVtbl[7]))((CManakopter*)Unsafe.AsPointer(ref this), damage, attackingEntityId);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CManakopter*, uint, void>)(lpVtbl[8]))((CManakopter*)Unsafe.AsPointer(ref this), damage);
        }
