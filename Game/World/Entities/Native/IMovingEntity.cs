...
namespace Forge.Game.World.Entities.Native
{
    ...
    public unsafe partial struct IMovingEntity : IMovingEntity.Interface
    {
        ...
        {
            return ((delegate* unmanaged[Thiscall]<IMovingEntity*, uint, uint>)(lpVtbl[6]))((IMovingEntity*)Unsafe.AsPointer(ref this), health);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<IMovingEntity*, uint, uint, void>)(lpVtbl[7]))((IMovingEntity*)Unsafe.AsPointer(ref this), damage, attackingEntityId);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<IMovingEntity*, uint, void>)(lpVtbl[8]))((IMovingEntity*)Unsafe.AsPointer(ref this), damage);
        }
