...
namespace Forge.Game.Config.Native
{
    ...
    public unsafe partial struct CStaticConfigVar : CStaticConfigVar.Interface
    {
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CStaticConfigVar*, wstring*, wstring*>)(lpVtbl[2]))((CStaticConfigVar*)Unsafe.AsPointer(ref this), @out);
        }
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CStaticConfigVar*, wstring*, wstring*>)(lpVtbl[5]))((CStaticConfigVar*)Unsafe.AsPointer(ref this), value);
        }
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CStaticConfigVar*, sbyte*, wstring*>)(lpVtbl[6]))((CStaticConfigVar*)Unsafe.AsPointer(ref this), value);
        }
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CStaticConfigVar*, float, int>)(lpVtbl[7]))((CStaticConfigVar*)Unsafe.AsPointer(ref this), value);
        }
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CStaticConfigVar*, int, int>)(lpVtbl[8]))((CStaticConfigVar*)Unsafe.AsPointer(ref this), value);
        }
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CStaticConfigVar*, sbyte, uint*>)(lpVtbl[9]))((CStaticConfigVar*)Unsafe.AsPointer(ref this), deleteMemory);
        }
