...
namespace Forge.Game.Config.Native
{
    ...
    public unsafe partial struct CConfigVarInt : CConfigVarInt.Interface
    {
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CConfigVarInt*, wstring*, wstring*>)(lpVtbl[2]))((CConfigVarInt*)Unsafe.AsPointer(ref this), @out);
        }
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CConfigVarInt*, wstring*, wstring*>)(lpVtbl[5]))((CConfigVarInt*)Unsafe.AsPointer(ref this), value);
        }
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CConfigVarInt*, sbyte*, wstring*>)(lpVtbl[6]))((CConfigVarInt*)Unsafe.AsPointer(ref this), value);
        }
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CConfigVarInt*, float, int>)(lpVtbl[7]))((CConfigVarInt*)Unsafe.AsPointer(ref this), value);
        }
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CConfigVarInt*, int, int>)(lpVtbl[8]))((CConfigVarInt*)Unsafe.AsPointer(ref this), value);
        }
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CConfigVarInt*, sbyte, uint*>)(lpVtbl[9]))((CConfigVarInt*)Unsafe.AsPointer(ref this), deleteMemory);
        }
