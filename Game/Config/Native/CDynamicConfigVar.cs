...
{
    // Struct Size: 0x8
    [NativeTypeName("struct CDynamicConfigVar : CConfigVar")]
    [NativeInheritance(nameof(CConfigVar))]
    public unsafe partial struct CDynamicConfigVar : CDynamicConfigVar.Interface
    {
        public void** lpVtbl;
        ...
        public int GetInt()
        {
            return ((delegate* unmanaged[Thiscall]<CDynamicConfigVar*, int>)(lpVtbl[0]))((CDynamicConfigVar*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CDynamicConfigVar*, double>)(lpVtbl[1]))((CDynamicConfigVar*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CDynamicConfigVar*, wstring*, wstring*>)(lpVtbl[2]))((CDynamicConfigVar*)Unsafe.AsPointer(ref this), @out);
        }
        ...
        public int* GetList()
        {
            return ((delegate* unmanaged[Thiscall]<CDynamicConfigVar*, int*>)(lpVtbl[3]))((CDynamicConfigVar*)Unsafe.AsPointer(ref this));
        }
        ...
        public int* GetArray()
        {
            return ((delegate* unmanaged[Thiscall]<CDynamicConfigVar*, int*>)(lpVtbl[4]))((CDynamicConfigVar*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CDynamicConfigVar*, wstring*, wstring*>)(lpVtbl[5]))((CDynamicConfigVar*)Unsafe.AsPointer(ref this), value);
        }
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CDynamicConfigVar*, sbyte*, wstring*>)(lpVtbl[6]))((CDynamicConfigVar*)Unsafe.AsPointer(ref this), value);
        }
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CDynamicConfigVar*, float, int>)(lpVtbl[7]))((CDynamicConfigVar*)Unsafe.AsPointer(ref this), value);
        }
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CDynamicConfigVar*, int, int>)(lpVtbl[8]))((CDynamicConfigVar*)Unsafe.AsPointer(ref this), value);
        }
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CDynamicConfigVar*, sbyte, uint*>)(lpVtbl[9]))((CDynamicConfigVar*)Unsafe.AsPointer(ref this), deleteMemory);
        }
