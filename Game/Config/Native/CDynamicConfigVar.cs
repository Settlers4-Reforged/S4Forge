...
namespace Forge.Game.Config.Native
{
    ...
    public unsafe partial struct CDynamicConfigVar : CDynamicConfigVar.Interface
    {
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CDynamicConfigVar*, wstring*, uint>)(lpVtbl[2]))((CDynamicConfigVar*)Unsafe.AsPointer(ref this), name);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CDynamicConfigVar*, int, void>)(lpVtbl[5]))((CDynamicConfigVar*)Unsafe.AsPointer(ref this), a1);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CDynamicConfigVar*, int, void>)(lpVtbl[6]))((CDynamicConfigVar*)Unsafe.AsPointer(ref this), a1);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CDynamicConfigVar*, float, void>)(lpVtbl[7]))((CDynamicConfigVar*)Unsafe.AsPointer(ref this), value);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CDynamicConfigVar*, int, void>)(lpVtbl[8]))((CDynamicConfigVar*)Unsafe.AsPointer(ref this), a1);
        }
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CDynamicConfigVar*, sbyte, uint*>)(lpVtbl[9]))((CDynamicConfigVar*)Unsafe.AsPointer(ref this), a2);
        }
