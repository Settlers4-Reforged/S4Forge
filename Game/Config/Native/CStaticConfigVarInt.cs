...
{
    // Struct Size: 0xC
    [NativeTypeName("struct CStaticConfigVarInt : CStaticConfigVar")]
    [NativeInheritance(nameof(CStaticConfigVar))]
    public unsafe partial struct CStaticConfigVarInt : CStaticConfigVarInt.Interface
    {
        public void** lpVtbl;
        ...
        [NativeInheritance(nameof(CStaticConfigVarInt))]
        public int value;
        ...
        public int GetInt()
        {
            return ((delegate* unmanaged[Thiscall]<CStaticConfigVarInt*, int>)(lpVtbl[0]))((CStaticConfigVarInt*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CStaticConfigVarInt*, double>)(lpVtbl[1]))((CStaticConfigVarInt*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CStaticConfigVarInt*, wstring*, wstring*>)(lpVtbl[2]))((CStaticConfigVarInt*)Unsafe.AsPointer(ref this), @out);
        }
        ...
        public int* GetList()
        {
            return ((delegate* unmanaged[Thiscall]<CStaticConfigVarInt*, int*>)(lpVtbl[3]))((CStaticConfigVarInt*)Unsafe.AsPointer(ref this));
        }
        ...
        public int* GetArray()
        {
            return ((delegate* unmanaged[Thiscall]<CStaticConfigVarInt*, int*>)(lpVtbl[4]))((CStaticConfigVarInt*)Unsafe.AsPointer(ref this));
        }
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CStaticConfigVarInt*, wstring*, wstring*>)(lpVtbl[5]))((CStaticConfigVarInt*)Unsafe.AsPointer(ref this), value);
        }
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CStaticConfigVarInt*, sbyte*, wstring*>)(lpVtbl[6]))((CStaticConfigVarInt*)Unsafe.AsPointer(ref this), value);
        }
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CStaticConfigVarInt*, float, int>)(lpVtbl[7]))((CStaticConfigVarInt*)Unsafe.AsPointer(ref this), value);
        }
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CStaticConfigVarInt*, int, int>)(lpVtbl[8]))((CStaticConfigVarInt*)Unsafe.AsPointer(ref this), value);
        }
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CStaticConfigVarInt*, sbyte, uint*>)(lpVtbl[9]))((CStaticConfigVarInt*)Unsafe.AsPointer(ref this), deleteMemory);
        }
