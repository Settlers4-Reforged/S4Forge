...
namespace Forge.Game.Config.Native
{
    ...
    public unsafe partial struct CStaticConfigVarInt : CStaticConfigVarInt.Interface
    {
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CStaticConfigVarInt*, wstring*, uint>)(lpVtbl[2]))((CStaticConfigVarInt*)Unsafe.AsPointer(ref this), name);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CStaticConfigVarInt*, int, void>)(lpVtbl[5]))((CStaticConfigVarInt*)Unsafe.AsPointer(ref this), a1);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CStaticConfigVarInt*, int, void>)(lpVtbl[6]))((CStaticConfigVarInt*)Unsafe.AsPointer(ref this), a1);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CStaticConfigVarInt*, float, void>)(lpVtbl[7]))((CStaticConfigVarInt*)Unsafe.AsPointer(ref this), value);
        }
        ...
        {
            ((delegate* unmanaged[Thiscall]<CStaticConfigVarInt*, int, void>)(lpVtbl[8]))((CStaticConfigVarInt*)Unsafe.AsPointer(ref this), a1);
        }
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CStaticConfigVarInt*, sbyte, uint*>)(lpVtbl[9]))((CStaticConfigVarInt*)Unsafe.AsPointer(ref this), a2);
        }
