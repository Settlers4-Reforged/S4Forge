...
namespace Forge.Game.Config.Native
{
    ...
    public unsafe partial struct CStaticConfigVarString : CStaticConfigVarString.Interface
    {
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CStaticConfigVarString*, wstring*, wstring*>)(lpVtbl[2]))((CStaticConfigVarString*)Unsafe.AsPointer(ref this), @out);
        }
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CStaticConfigVarString*, wstring*, wstring*>)(lpVtbl[5]))((CStaticConfigVarString*)Unsafe.AsPointer(ref this), value);
        }
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CStaticConfigVarString*, sbyte*, wstring*>)(lpVtbl[6]))((CStaticConfigVarString*)Unsafe.AsPointer(ref this), value);
        }
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CStaticConfigVarString*, float, int>)(lpVtbl[7]))((CStaticConfigVarString*)Unsafe.AsPointer(ref this), value);
        }
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CStaticConfigVarString*, int, int>)(lpVtbl[8]))((CStaticConfigVarString*)Unsafe.AsPointer(ref this), value);
        }
        ...
        {
            return ((delegate* unmanaged[Thiscall]<CStaticConfigVarString*, sbyte, uint*>)(lpVtbl[9]))((CStaticConfigVarString*)Unsafe.AsPointer(ref this), deleteMemory);
        }
